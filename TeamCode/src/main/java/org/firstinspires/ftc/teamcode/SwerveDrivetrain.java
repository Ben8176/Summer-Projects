...
//                1 - (Math.max(leftRPM, rightRPM) * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR) / (MAX_MOTOR_RPM);
         ...
         */
        double m0RPM =
                (-(wheelModifier * leftInvert * WHEEL_TO_MODULE * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR)
                        + leftSign * leftRPM * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR) * safety;
        ...
        double m1RPM =
                ((wheelModifier * leftInvert * leftWheelRPM * WHEEL_TO_MODULE * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR)
                        + leftSign * leftRPM * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR) * safety;
        double m2RPM =
                (-(wheelModifier * rightInvert * WHEEL_TO_MODULE * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR)
                        + rightSign * rightRPM * MODULE_TO_INTERMEDIATE * INTERMEDIATE_TO_MOTOR) * safety;
        ...
        telemetry.addData("leftrotTHETA", leftModuleTheta);
        telemetry.addData("leftrotPHI", leftModulePhi);
